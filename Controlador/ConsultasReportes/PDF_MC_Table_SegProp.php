...
require('../../public/fpdf/fpdf.php'); 
  ...
  * To do so, the height of the row must be known in advance; it is the maximum of the heights of the iCells it is made up of.
  * To know the height of a MultiCell, the NbLines() method is used: it returns the number of lines a MultiCell  occupy.
  *
  * @category  PDF
  * @package   PDF_MC
