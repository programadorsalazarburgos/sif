...
$width=190;
$respuesta = mysql_query('SELECT VC_Organizacion FROM tb_propuesta_usuarios WHERE PK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetWidths(array($width));
$pdf->Ln();
		while($fila = mysql_fetch_array($respuesta)){
			$pdf->Row(array('PROPUESTA PRESENTADA POR LA ORGANIZACION '.strtoupper($fila["VC_Organizacion"])));
		}
...
$respuesta = mysql_query('SELECT * FROM tb_propuesta_proyecto WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFont('Arial','B',9);
$pdf->SetFillColor(0,69,134);
$pdf->SetTextColor(255,255,255);
...
$respuesta = mysql_query('SELECT VC_Nombre_Entidad, VC_Nit, VC_Direccion, LOC.VC_Nom_Localidad, VC_Objeto_Social, VC_Telefono, VC_Correo, IN_Estrato_Sede FROM tb_propuesta_organizacion_precontractual ORG JOIN tb_localidades LOC ON ORG.IN_Id_Localidad = LOC.PK_Id_Localidad WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFillColor(204,204,204);
$pdf->Ln();
...
$respuesta = mysql_query('SELECT VC_Representante_Legal, VC_Cedula_RL, VC_Direccion_RL, VC_Telefono_RL, VC_Correo_RL FROM tb_propuesta_organizacion_precontractual WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFillColor(204,204,204);
...
$respuesta = mysql_query('SELECT VC_Nombre_Director, VC_Cedula_Director, VC_Direccion_Director, VC_Telefono_Director, VC_Correo_Director FROM tb_propuesta_proyecto WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFillColor(204,204,204);
...
$pdf->Ln();
$pdf->SetTextColor(0,0,0);
$respuesta = mysql_query('SELECT VC_Antecedentes FROM tb_propuesta_proyecto WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFont('Arial','',9);
		$width=190;
		$pdf->SetWidths(array($width));
		while($fila = mysql_fetch_array($respuesta)){
...
$respuesta = mysql_query('SELECT * FROM tb_propuesta_historial_organizacion WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFillColor(204,204,204);
$pdf->SetTextColor(0,0,0);
...
$pdf->Ln();
$pdf->SetTextColor(0,0,0);
$respuesta = mysql_query('SELECT VC_Descripcion_Problema FROM tb_propuesta_proyecto WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFont('Arial','',9);
		$width=190;
		$pdf->SetFont('Arial','',9);
		$pdf->SetWidths(array($width));
...
$pdf->Ln();
$respuesta = mysql_query('SELECT VC_Objetivo_General FROM tb_propuesta_proyecto WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
		$width=190;
		$pdf->SetWidths(array($width));
		while($fila = mysql_fetch_array($respuesta)){
...
$pdf->Ln();
		...
		$pdf->Ln();
$respuesta = mysql_query('SELECT * FROM tb_propuesta_proyecto_obj_especificos WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFont('Arial','',9);
		$width=190/2;
...
$pdf->Ln();
$pdf->SetTextColor(0,0,0);
$respuesta = mysql_query('SELECT VC_Descripcion_Proyecto FROM tb_propuesta_proyecto WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFont('Arial','',9);
		$width=190;
		$pdf->SetWidths(array($width));
		while($fila = mysql_fetch_array($respuesta)){
...
$pdf->Ln();
$pdf->SetTextColor(0,0,0);
$respuesta = mysql_query('SELECT VC_Beneficiarios, FL_Cantidad_Beneficiados FROM tb_propuesta_proyecto WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
		$pdf->SetFont('Arial','',9);
		$width=190;
		$pdf->SetWidths(array($width));
...
$width=190/5;
		...
		$pdf->Ln();
$respuesta = mysql_query('SELECT * FROM tb_propuesta_proyecto_metas WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFont('Arial','',9);
		$width=190/5;
...
$width=190/5;
		...
		$pdf->Cell($width,8,'Periodo',1,0,'C'); //Titulo del reporte
		$pdf->Ln();
$respuesta = mysql_query('SELECT * FROM tb_propuesta_proyecto_indicadores WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFont('Arial','',9);
		$width=190/5;
...
$pdf->SetTextColor(0,0,0);
$width=190/3;
$respuesta = mysql_query('SELECT * FROM tb_propuesta_proyecto_equipo WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'";');
$pdf->SetFont('Arial','',9);
		$width=190;
		$pdf->SetWidths(array($width));
		while($fila = mysql_fetch_array($respuesta)){
...
$pdf->SetFillColor(204,204,204);
		...
		$pdf->Ln();
$respuesta = mysql_query('SELECT * FROM tb_propuesta_proyecto_archivos WHERE FK_Id_Usuario="'.$_SESSION['id_usuario'].'" AND VC_Fuente="PROPUESTA";');
$pdf->SetFont('Arial','',9);
		$width=190/2;
		$pdf->SetWidths(array($width));
		while($fila = mysql_fetch_array($respuesta)){
