            ...
            success: function(data)
            {
            		...
            		bootbox.alert("Por favor imprima o guarde el siguiente reporte, deberá <strong>radicarlo FIRMADO cuando se le indique.</strong>", function(){
            			...
            			if(location.includes("localhost") == true){
            				window.location.href = "http://localhost/sif/ConvocatoriaOrganizaciones/menuorganizacion.php";
            			}
            			else{
            				window.location.href = "https://sif.idartes.gov.co/ConvocatoriaOrganizaciones/menuorganizacion.php";
            			}
