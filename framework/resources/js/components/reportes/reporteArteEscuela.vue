...
<div id="general">
    ...
    <div class="content-header" style="padding: 5px !important" v-if="mostrar_reporte==1">
        <div class="card">
            <h5 class="card-header">REPORTE ARTE EN LA ESCUELA</h5>
            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="userinput1">Años</label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="userinput1">Mes</label>                                                   
                                                      <select class="form-control" v-model="mes" required @change="obtenerColegios()">
                                                        <option value="0" disabled>Seleccione</option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="userinput1">Colegio</label>
                                                    <select class="form-control" v-model="colegio" required>
                                                        <option value="0" disabled>Seleccione</option>
                                                        <option v-for="data in arrayColegios" :key="data.PK_Id_Colegio" :value="{PK_Id_Colegio: data.PK_Id_Colegio, VC_Nom_Colegio: data.VC_Nom_Colegio}">{{data.VC_Nom_Colegio}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td v-for="data in areas" :key="data.id">
                                                                    <template v-if="data.CANTIDAD == null">
                                                                        0
                                                                    </template>
                                                                    <template v-if="data.CANTIDAD != null">
                                                                        {{data.CANTIDAD}}
                                                                ...
                                                                <td>{{totalCreadosMesPrograma}}</td>
                                                                <td>{{totalCerradosMesPrograma}}</td>
                                                                <td>{{coberturaTotalPrograma}}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
...
export default {
    data() {
        return {
            ...
            meses: [],
            porAreas: [],
            totalCreadosMesPrograma: "",
            totalCerradosMesPrograma: "",
            totalPrograma: 0,
    ...
    methods: {
        ...
        observacionesLinea() {
            let me = this;
            var url = 'observaciones_linea?anio=' + me.anio.PK_Id_Tabla + '&mes=' + me.mes.PK_Id_Tabla + '&colegio=' + me.colegio.PK_Id_Colegio + '&lineaAtencion=' + 1236;
            axios.get(url).then(function (response) {
                    var respuesta = response.data;
                    me.arrayObservaciones = respuesta.data;
                    console.log(me.arrayObservaciones);
                })
                .catch(function (error) {
                    var response = error.response.data;
                });
        ...
        guardarObservacion: function () {
            ...
            axios
                .post("guardarObservacion", {
                    FK_parametro_detalle_linea: 1236,
                    FK_colegio: me.colegio.PK_Id_Colegio,
        ...
        obtenerColegios() {
            let me = this;
            console.log(me.mes);
            var url = 'cargarColegios?anio=' + me.anio.VC_Descripcion + '&mes=' + me.mes.FK_Value;
            axios.get(url).then(function (response) {
                    var respuesta = response.data;
                    me.arrayColegios = respuesta.datos;
                })
                .catch(function (error) {
                    var response = error.response.data;
                });
        ...
        async reporte() {
            this.mensaje();
            let me = this;
            var url_graficos = 'atendidos_inscritos_escuela?anio=' + me.anio.VC_Descripcion + '&mes=' + me.mes.FK_Value + '&colegio=' + me.colegio.PK_Id_Colegio;
            ...
            if (me.tipoReporte == 2) {
                ...
                var url = 'reportePDFEscuela?anio=' + me.anio.VC_Descripcion + '&mes=' + me.mes.FK_Value + '&bar=' + bar + '&pie=' + pie + '&colegio=' + me.colegio.PK_Id_Colegio + '&nombreColegio=' + me.colegio.VC_Nom_Colegio + '&filtro=' + 2 +  '&anioId=' + me.anio.PK_Id_Tabla + '&mesId=' + me.mes.PK_Id_Tabla;
                axios
                    .get(url, {
                        responseType: 'blob',
            ...
            if (me.tipoReporte == 1) {
                me.observacion = "";
                me.fechaObservacion = "";
                var url = 'cargarPDFEscuela?anio=' + me.anio.VC_Descripcion + '&mes=' + me.mes.FK_Value + '&colegio=' + me.colegio.PK_Id_Colegio + '&filtro=' + 1 + '&anioId=' + me.anio.PK_Id_Tabla + '&mesId=' + me.mes.PK_Id_Tabla;
                axios.get(url).then(function (response) {
                        Swal.close();
                        ...
                        me.totalCreadosMesPrograma = respuesta.totalCreadosMesPrograma;
                        me.totalCerradosMesPrograma = respuesta.totalCerradosMesPrograma;
                        me.totalPrograma = respuesta.totalPrograma;
                        me.coberturaTotalPrograma = respuesta.coberturaTotalPrograma;
