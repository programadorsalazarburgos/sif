...
<div id="general">
    ...
    <div class="content-header" style="padding: 5px !important" v-if="mostrar_reporte==1">
        <div class="card">
            <h5 class="card-header">REPORTE CONVERGE</h5>
            <div class="card-body">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>{{totalPrograma}}</td>
                                                                <td v-for="data in areas" :key="data.id" style="text-align:center;">{{data.CANTIDAD}}</td>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <th>ATENDIDOS</th>
                                                                <td v-for="data in meses" :key="data.id" style="text-align:center;">{{data.atendidos}}</td>
                                                                <td style="text-align:center;">{{acumuladoBeneficiariosAtendidosAnio}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>INSCRITOS</th>
                                                                <td v-for="data in meses" :key="data.id" style="text-align:center;">{{data.inscritos}}</td>
                                                                <td style="text-align:center;">{{acumuladoBeneficiariosInscritosAnio}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>PORCENTAJE</th>
                                                                <td v-for="data in meses" :key="data.id" style="text-align:center;">{{data.porcentaje}}</td>
...
export default {
    ...
    methods: {
        ...
        observacionesLinea() {
            let me = this;
            var url = 'observaciones_linea?anio=' + me.anio.PK_Id_Tabla + '&mes=' + me.mes.PK_Id_Tabla + '&lineaAtencion=' + 1238;
            axios.get(url).then(function (response) {
                    var respuesta = response.data;
        ...
        guardarObservacion: function () {
            ...
            axios
                .post("guardarObservacion", {
                   FK_parametro_detalle_linea: 1238,
                    FK_colegio: null,
        ...
        async reporte() {
            this.mensaje();
            let me = this;
            var url_graficos = 'atendidos_inscritos?anio=' + me.anio.VC_Descripcion + '&mes=' + me.mes.FK_Value;
            ...
            if (me.tipoReporte == 2) {
                ...
                var url = 'reportePDF?anio=' + me.anio.VC_Descripcion + '&mes=' + me.mes.FK_Value + '&bar=' + bar + '&pie=' + pie + '&filtro=' + 2 + '&anioId=' + me.anio.PK_Id_Tabla + '&mesId=' + me.mes.PK_Id_Tabla;
                axios
                    .get(url, {
                        responseType: 'blob',
            ...
            if (me.tipoReporte == 1) {
                var url = 'cargarPDF?anio=' + me.anio.VC_Descripcion + '&mes=' + me.mes.FK_Value + '&filtro=' + 1 + '&anioId=' + me.anio.PK_Id_Tabla + '&mesId=' + me.mes.PK_Id_Tabla;
                axios.get(url).then(function (response) {
                        Swal.close();
