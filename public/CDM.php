...
<head>
  ...
  <link href="css/Siclan.css?v=2018.10.0" rel="stylesheet">
  <link rel="stylesheet" href="bower_components/amcharts/dist/amcharts/plugins/export/export.css" type="text/css" media="all" />

  <link rel="stylesheet" href="css/CDM.css?v?2020.03.11.0" type="text/css" rel="stylesheet">
  ...
  <script src="js/CDM.js?v=2021.03.17.1"></script>

  <script type="text/javascript" src="js/funcionesGenerales.js?v=2020.03.11.0"></script>
      ...
      <div class="row">
        <div class="col-xs-8 col-md-8 col-md-offset-2 text-center">
          ...
          <div class="col-md-8" style="border-style: outset; background-color: ghostwhite; border-radius: 3%;">
            <br>
            <h4>AÑO: 
              <a class="btn btn-default anio_inicio">2016</a>
              <a class="btn btn-default anio_inicio">2017</a>
              <a class="btn btn-default anio_inicio">2018</a>
              <a id="year2019" class="btn btn-default anio_inicio">2019</a>
              <a id="year2020" class="btn btn-default anio_inicio" style="background-color: teal; color: white;">2020</a></h4>
            ...
            <div id="filter_div">
              ...
              <span id="div_SL_LINEA_CREA" name="div_SL_LINEA_CREA" class="div_select">
                <select id="SL_LINEA_CREA" name="SL_LINEA_CREA" class="filtro selectpicker">
                  ...
                  <option value="2">Impulso Colectivo</option> <!-- EC -->
                  <option value="3">Converge</option> <!-- LC -->
                </select>
              </span>
