...
<head> 
	...
	<title>Beneficiarios por Aliado Secretaría de Seguridad (Convenio 0810-2019)</title>
	...
	<script type="text/javascript" src="Js/Consulta_Beneficiarios_Aliado_Convenio_0810_2019.js?v=2019.08.24.0"></script>
</head>
<body>
		...
		<div class="panel-success">
			<div class="panel-heading">
				<div class="page-header">
					<h1>Consulta de Beneficarios por Aliado Secretaría de Seguridad<small> (Convenio 0810-2019)</small></h1>
				</div>
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-xs-12 col-md-12 alert alert-warning">
						<p>Aquí podrá conocer la cantidad de beneficiarios que ha atendido cada uno de los aliados por medio del convenio de la Secretaría de Seguridad 0810-2019, según el rango de meses seleccionado.</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="col-xs-12 col-md-6 col-md-offset-4">
							<h4>Seleccione el rango de meses que desea consultar:</h4>
						</div>
					</div>
					<div class="col-md-12">
						<div class="col-xs-8 col-md-2 col-md-offset-3" style="text-align: right;">
							<label for="SL_Mes_Desde">Desde:</label>
						</div>
						<div class="col-xs-12 col-md-2">
							<select id="SL_Mes_Desde" class="form-control selectpicker">
							</select>
						</div>					
					</div>		
					<div class="col-md-12">
						<div class="col-xs-8 col-md-2 col-md-offset-3" style="text-align: right;">
							<label for="SL_Mes_Hasta">Hasta:</label>
						</div>
						<div class="col-xs-12 col-md-2">
							<select id="SL_Mes_Hasta" class="form-control selectpicker">
							</select>
						</div>
					</div>
					...
					<div class="tab-pane active" id="grupos_laboratorio_clan" role="tabpanel">
						<div class="row">
							<div class="col-xs-12 col-md-12 text-center bg-info">
								<h4>CONVERGE (SECRETRARÍA DE SEGURIDAD)<small> Beneficiarios Atendidos por Aliado</small></h4>
							</div> 
						</div>
						<div class="row">
							<div class="col-xs-12 col-md-12">
								<div class="table-responsive">
									<div id="div_table_aliados_convenio"></div> 
								</div>
							</div>
						</div>
					</div>					
