...
<head>
	...
	<title>Gráfica gestión beneficiarios CREA</title>
		...
		<div class="panel panel-success">
			<div class="panel-heading"> 
				<div class="page-header">
					<h1>Gráfica <small>Gestión Beneficiarios CREA</small></h1>
				</div>
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-xs-6 col-md-2">
						<label for="SL_tipo_consulta">Tipo Consulta:</label>
					</div>
					<div class="col-xs-12 col-md-4">
						<select id="SL_tipo_consulta" class="form-control selectpicker" data-live-search="true">
							<optgroup label="Asignación">
								<option value="asignaciones">Asignaciones a grupos</option>
								<option value="remociones">Remociones de grupos</option>
							</optgroup>
							<optgroup label="Creación">
								<option value="creaciones_simat">Beneficiarios creados por fuente SIMAT</option>
								<option value="creaciones_formulario">Beneficiarios creados por formulario SIF</option>
							</optgroup>
						</select>
					</div>
					<div id="div_linea_atencion">
						<div class="col-xs-6 col-md-2">
							<label for="SL_linea_atencion">Línea atención:</label>
						</div>
						<div class="col-xs-12 col-md-4">
							<select id="SL_linea_atencion" class="form-control selectpicker" data-live-search="true"></select>
						</div>
					</div>
				</div>
				<div class="row">
