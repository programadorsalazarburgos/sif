...
<head>
    ...
    <script type="text/javascript" src="Js/Consultar_Asistencias_Colegio_Area_Mes.js?v=2018.9.19.1"></script> 
		...
		<div class="panel panel-success">
			<div class="panel-heading">
				<div class="page-header">
					<h1>Consultar asistencia por área artística</h1>
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-xs-12 col-md-9">
						<select id="SL_clan" multiple="multiple" class="form-control selectpicker" data-actions-box="true" data-select-all-text="Todos" data-deselect-all-text="Ninguno"   data-live-search="true"></select>
					</div>								
					<div class="col-xs-12 col-md-3"> 
						<label for="SL_colegio">Seleccione el colegio:</label>
					</div>
					<div class="col-xs-12 col-md-9"> 
						<select id="SL_colegio" multiple="multiple" class="form-control selectpicker" data-actions-box="true" data-select-all-text="Todos" data-deselect-all-text="Ninguno" data-live-search="true"></select>  
					</div>
					<div class="col-xs-12 col-md-3"> 
						<label for="SL_area">Seleccione el Área:</label>
					</div>
					<div class="col-xs-12 col-md-9">  
						<select id="SL_area" multiple="multiple" class="form-control selectpicker" data-actions-box="true" selectAllText="Seleccionar Todos" deselectAllText="Deselccionar Todos" data-live-search="true"></select>  
					</div>					
					<div class="col-xs-12 col-md-3">  
				...
				<div class="row">
					<div class="col-xs-12 col-md-12 table-responsive">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 alert alert-info">
							<div id="LB_Atendidos">Atendidos</div>
						</div>
						<label for=""></label>
