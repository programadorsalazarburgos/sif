...
<head>
    ...
    <script type="text/javascript" src="Js/Consultar_Asistencia_EC_Y_LC_Mes.js?v=2020.07.07.1"></script> 
		...
		<div class="panel panel-success">
			<div class="panel-heading">
				<div class="page-header">
					<h1>Consulta Detallada Asistencia Impulso Colectivo Y Converge</h1>
				...
				<div class="row">
					<div class="col-xs-12 col-md-12 table-responsive">
						<div class="alert alert-warning">
							<h4 class="text-center">Datos de asistencia</h4>
						</div>
