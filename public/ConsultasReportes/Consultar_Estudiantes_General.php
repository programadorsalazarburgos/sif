			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-xs-12 col-md-12 alert alert-warning">
						<p>
							A continuación va a encontrar todos los estudiantes, puede usar la celda <b>Filtrar</b> para encontrar los grupos pertenecientes a un Área Artística espcifica, Colegio u otro.
						</p>
					</div>
				</div>
