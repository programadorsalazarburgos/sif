...
<head>
	...
	<title>Administración Grupos Circulación</title>
	...
	<div class="container-fluid">
		...
		<div class="panel-heading">
			<div class="page-header">
				<h1>Administración de Grupos Evento</h1>
			</div>
		</div>
		...
		<div class="tab-content">
				<div class="tab-pane active" id="creacion_duplas" role="tabpanel">
					<form id="form_nuevo_dupla">
						<div class="row">
							<div class="col-xs-12 col-md-12 text-center bg-info">
								<h4>Creación de Grupo</h4>
							</div>
						</div>
					<?php echo "<input type='hidden' id='id_usuario' name='id_usuario' value='".$Id_Persona."'" ?>
						<fieldset>
                             <br>
							<legend><font color="teal">Datos de Grupo</font></legend>
							<div class="form-group">
								<label class="col-md-3" for="TX_CodigoDupla">Equipo Asignado:</label>
								<div class="col-md-9">
							...
							<div class="form-group">
								<label class="col-md-3" for="TX_CodigoDupla">Evento:</label>
								<div class="col-md-9">
									<input type="text"  class="form-control" id="TX_CodigoDupla" name="TX_CodigoDupla">
									<span class="help-block" id="error"></span>
								</div>
							...
							<div class="form-group">
								<label class="col-md-3" for="SL_Artistas">Población a Atender:</label>
								<div class="col-md-9">
					...
					<legend><font color="teal">Asuntos Operativos</font></legend>

						<div class="form-group">
							<label class="col-md-3" for="TX_CodigoDupla">Transporte:</label>
							<div class="col-md-9">
								<input type="text"  class="form-control" id="TX_CodigoDupla" name="TX_CodigoDupla">
								<span class="help-block" id="error"></span>
							</div>
						...
						<div class="form-group">
							<label class="col-md-3" for="TX_CodigoDupla">Datos Contacto Transporte:</label>
							<div class="col-md-9">
								<input type="text"  class="form-control" id="TX_CodigoDupla" name="TX_CodigoDupla">
								<span class="help-block" id="error"></span>
							</div>
						...
						<div class="form-group">
							<label class="col-md-3" for="TX_CodigoDupla">Hora Citación Transporte:</label>
							<div class="col-md-9">
								<input type="text"  class="form-control" id="TX_CodigoDupla" name="TX_CodigoDupla">
								<span class="help-block" id="error"></span>
							</div>
						...
						<div class="form-group">
							<label class="col-md-3" for="TX_CodigoDupla">Duplas o Artistas de Apoyo:</label>
							<div class="col-md-9">
								<input type="text"  class="form-control" id="TX_CodigoDupla" name="TX_CodigoDupla">
								<span class="help-block" id="error"></span>
							</div>
                            ...
                            <div class="row">
								<div class="col-xs-6 col-xs-offset-3 col-md-6 col-md-offset-3">
									<input class="form-control btn btn-primary"  id="BT_guardar_dupla" type="submit" value="Guardar Grupo">
								</div>
							</div>
						</fieldset>
					</form>
