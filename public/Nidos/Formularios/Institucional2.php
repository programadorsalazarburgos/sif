...
<body style="background-color: #ffefdb">
	...
	<div class="container-fluid">
		...
		<input type="hidden" id="TX_Formulario" value="2">
		<form class="form" id="form_institucional">
						...
						<div id="Informacion_potestaNo" style="display: none;">		
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										<label>Nombres</label>	
										<input type="text" class="form-control mayuscula" id="TX_Nombres_Beneficiario">
									</div>
									<div class="col-md-6">
										<label>Apellidos</label>	
										<input type="text" class="form-control mayuscula" id="TX_Apellidos_Beneficiario">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<div class="col-md-6" style="display: none;" id="div-check-si">
										<label>Fecha de nacimiento</label><input type="date" class="form-control" id="TX_Fec_Nac_Beneneficiario">
									</div>
									<div class="col-md-6" style="display: none;" id="div-check-no">
										<label>Edad</label>
										<select class="form-control selectpicker" title="Seleccione una opción" data-live-search="true" id="SL_Edad_Beneficiario">
									...
									<div class="col-md-6">
										...
										<select class="form-control selectpicker" title="Seleccione una opción" id="SL_Enf_Beneficiario"></select>
									</div>
								</div>
							</div>
						</div>
						<div id="Informacion_potestaSi" style="display: none;">
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										<label>Tipo de documento</label>
										<select class="form-control selectpicker" title="Seleccione una opción" data-live-search="true" id="SL_Tipo_Doc_Beneficiario"></select>
									</div>
									<div class="col-md-6">
										<label>Número de documento</label>	
										<input type="number" class="form-control" id="TX_Identificacion_Beneficiario">
									</div>
								</div>
							</div>
						</div>		
				...
				<div class="panel panel-primary col-md-8 col-md-offset-2">
					...
					<div class="panel-body">
						<div class="form-group">
							<div class="row">
								<div class="col-md-6">
									<label>Nombre de la institución o programa al que te encuentras vinculada</label>
									<input class="form-control" type="text" id="TX_Institucion" required>
								</div>
								<div class="col-md-6">
									<label>¿A qué entidad pertenece dicha institución o programa?</label>
									<select class="form-control selectpicker" title="Seleccione una opción" id="SL_Entidad" required></select>
								</div>
							</div>
						</div>
						<div class="form-group">
