	...
	<div class="container-fluid">
		...
		<div class="panel-heading">
			<div class="page-header">
				<h1>Administración de duplas</h1>
			</div>
		</div>
		...
		<div class="tab-content">
					...
					<form id="form_nuevo_dupla">
						<div class="row">
							<div class="col-xs-12 col-md-12 text-center bg-info">
								<h4>Creación De Duplas</h4>
							</div>
						</div>
					<?php echo "<input type='hidden' id='id_usuario' name='id_usuario' value='".$Id_Persona."'" ?>
						<fieldset>
              <br>
							<legend><font color="teal">Datos Dupla:</font></legend>
							<div class="form-group">
								<label class="col-md-3" for="SL_Territorial">Gestor Territorial:</label>
								<div class="col-md-9">
									<input type="text" class="form-control TX_Gestor" disabled="disabled" id="TX_Gestor" name="TX_Gestor">
									<input type="hidden" value="<?php echo $Id_Persona;?>" class="form-control" disabled="disabled" id="SL_Territorial" name="SL_Territorial">
									<span class="help-block" id="error"></span>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3" for="SL_Territorio">Territorio:</label>
								<div class="col-md-9">
									 <input type="hidden" class="form-control" disabled="disabled" id="TX_IdTerritorio" name="TX_IdTerritorio">
                   <input type="text" class="form-control" disabled="disabled" id="SL_Territorio" name="SL_Territorio">
									<span class="help-block" id="error"></span>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3" for="SL_Tipo_Dupla">Tipo de Dupla:</label>
								<div class="col-md-9">
									<select class="form-control selectpicker" data-live-search="true" name="SL_Tipo_Dupla" id="SL_Tipo_Dupla" title="Seleccione el tipo de dupla"></select>
									<span class="help-block" id="error"></span>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3" for="TX_CodigoDupla">Código de Dupla:</label>
								<div class="col-md-9">
              ...
              <div class="row">
								<div class="col-xs-6 col-xs-offset-3 col-md-6 col-md-offset-3">
									<input class="form-control btn btn-primary"  id="BT_guardar_dupla" type="submit" value="Guardar Dupla">
								</div>
							</div>
						</fieldset>
					</form>
