...
<head>
	...
	<script type="text/javascript" src="Js/Registro_AsistenciaNidos.js?v=2021.04.22.05"></script>
						...
						<div id="div-reporte-evento" style="display: none;">
							...
							<div class="row">
								<div class='col-xs-4 col-md-4'>
									<table id='table-lugar-atencion' class='table table-striped table-bordered table-hover' width='100%' style='font-size: 12px;'>
										<thead>
											<tr>
									...
									<table id='table-reporte-experiencias' class='table table-striped table-bordered table-hover' width='100%' style='font-size: 12px;'>
										<thead>
											<tr>
												...
												<th rowspan='2' style='background-color: #E59866'>Anexo soporte</th>
