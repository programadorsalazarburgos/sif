		...
		<div class="panel panel-success">
			<div class="panel-heading">
				<div class="page-header">
					<h1>Valoración de Grupos <small>Artista Formador</small></h1>
				</div>
			</div>
			<div class="panel-body">
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item active" ><a class="nav-link" data-toggle="tab" href="#valoracion" role="tab" id="a_valoracion">Nueva Valoración</a></li>
											...
											<table class="table table-bordered" style="border-color: black;margin-bottom: 0px !important;">
												<tbody>										
													<tr>
														...
														<td colspan="5" class="text-center"><br><br><b>GESTIÓN DE FORMACIÓN EN LAS PRÁCTICAS ARTÍSTICAS</b><br>FICHA DE VALORACIÓN – PROCESO DE FORMACIÓN ARTÍSTICA</td>
														<td colspan="2" class="text-center"><b>Código: 1MI-GFOR-F-25</b><br>Fecha: 26/11/2018<br>Versión: 01<br>Página : 1 de 1</td>
													</tr>
													<tr>
														...
														<td colspan="1" class="contenedor"><b>Organización: IDARTES</b></td>
														<td colspan="1" class="contenedor"><b>Progama: CREA</b></td>
														<td colspan="1" class="contenedor"><b><span id="LB_Linea_Atencion">Línea: Arte en la Escuela</span></b></td>
													</tr>
													<tr>
														<td colspan="2" class="contenedor"><b><span id="LB_Area_Artistica">Area Artística:</span></b></td>
													...
													<tr>
														<td colspan="2" class="contenedor"><b><span id="LB_Codigo_Grupo">Código Grupo:</span></b></td>
													...
													<tr>
														<td colspan="2" class="contenedor"><b><span id="LB_Codigo_Grupo">Descriptor de desempeño 1:</span></b></td>
														<td colspan="2" class="contenedor"><b><span id="LB_Codigo_Grupo">Descriptor de desempeño 2:</span></b></td>
														<td colspan="2" class="contenedor"><b><span id="LB_Codigo_Grupo">Descriptor de desempeño 3:</span></b></td>
