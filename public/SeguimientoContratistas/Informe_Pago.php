...
<head>
	...
	<script src="Js/Informe_Pago.js?v=2021_06_10.14.12"></script>
	<link rel="stylesheet" type="text/css" href="Css/Informe_Pago.css?v=2021.06.05.99">
...
<body>
				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="informe_pago" role="tabpanel">
						<div class="alert alert-dismissible alert-danger">
							<strong>NOTA IMPORTANTE:</strong><br> Si sus honorarios son mayores o iguales a <b>$ 5.201.000</b>, puede hacer uso de los alivios tributarios, consulte la circular <a href="../Circular_004.pdf" target="_blank">AQUÍ</a>.
						</div>
										...
										<div align=center>
											<table border=0 cellpadding=0 cellspacing=0 width=1107 class=xl6425986 style='border-collapse:collapse;table-layout:fixed;width:831pt'>
												...
												<tr height=28 style='mso-height-source:userset;height:21.0pt'>
													...
													<td colspan=8 class=xl18025986 data-toggle="tooltip" title="Campo generado automácticamente cuando se aprueba por parte del supervisor" data-placement="right">DD/MM/AAAA</td>
													<!--
													<td colspan=8 class=xl18025986 data-toggle="tooltip" title="" data-placement="right">
														<input maxlength="50" style="background-color:white; color:black;" class="text-center form-control avisos" data-toggle="tooltip" data-placement="right" title="Campo generado automácticamente cuando se aprueba por parte del supervisor" disabled readonly  id="input-fecha-informe" name="input-fecha-informe" placeholder="DD/MM/AAAA" type="text">
													</td>
													-->
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
												...
												<tr height=36 style='mso-height-source:userset;height:27.0pt'>
													...
													<td colspan=5 class=xl18025986 style='border-left:none;height:  10px;color:black;'><input maxlength="50" style="background-color:white; color:black;" class="text-center form-control datepicker-class" readonly required="required" id="input-periodo-inicio" name="input-periodo-inicio" placeholder="DD/MM/AAAA" type="text"></td>
													<td colspan=5 class=xl18025986 style='border-left:none;height:  10px;color:black;'><input maxlength="50" style="background-color:white; color:black;" class="text-center form-control datepicker-class" readonly required="required" id="input-periodo-fin" name="input-periodo-fin" placeholder="DD/MM/AAAA" type="text"></td>
												...
												<tr height=39 style='mso-height-source:userset;height:29.25pt'>
													...
													<td colspan=5 class=xl12025986 style='border-left:none;height:  10px;color:black;'><input style="width: 100%; height: 100%;" type="text" name="input-identificacion" id="input-identificacion" required="required" readonly></td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
												...
												<tr height=23 style='mso-height-source:userset;height:17.25pt'>
													...
													<td colspan=9 rowspan=2 class=xl17125986 style='border-left:none;height:  10px;color:black;'>
														<select class="financiero" style="width: 100%; height: 100%;"  name="select-banco" id="select-banco" required="required" >
														</select>
													</td>
													<td colspan=5 rowspan=2 class=xl17425986>TIPO DE CUENTA:</td>
													<td colspan=6 rowspan=2 class=xl17125986 style='border-left:none;height:  10px;color:black;'><input class="financiero" style="width: 100%; height: 100%;" type="text" name="input-tipo-cuenta" id="input-tipo-cuenta" required="required"></td>
													<td colspan=4 rowspan=2 class=xl17425986>No. CUENTA:</td>
													<td colspan=8 rowspan=2 class=xl17125986 style='border-left:none;height:  10px;color:black;'><input class="financiero" style="width: 100%; height: 100%;" type="text" name="input-numero-cuenta" id="input-numero-cuenta" required="required"></td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
												...
												<tr height=50 style='mso-height-source:userset;height:37.5pt'>
													...
													<td colspan=31 class=xl16425986 width=985 style='border-left:none;height:  10px;color:black;'><textarea class="financiero" rows="3" style="resize: vertical;width: 100%; height: 100%; margin-bottom: -5px;" type="text" name="input-objeto" id="input-objeto" required="required"></textarea></td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
												...
												<tr height=30 style='mso-height-source:userset;height:22.5pt'>
													...
													<td colspan=4 rowspan=2 class=xl15925986 style='border-left:none;height:  10px;color:black;'><input class="financiero" style="width: 100%; height: 100%;" type="text" name="input-plazo-inicial" id="input-plazo-inicial" required="required"></td>
												...
												<tr height=23 style='mso-height-source:userset;height:17.25pt'>
													...
													<td colspan=4 class=xl12025986 style='height: 10px;color:black;'><input style="width: 100%; height: 100%;" type="text" class="numberOnly financiero" name="input-numero-pagos" id="input-numero-pagos" required="required" ></td>
												...
												<tr height=32 style='mso-height-source:userset;height:24.0pt'>
													...
													<td colspan=2 class=xl12025986 style='height: 10px;color:black;'><input class="financiero" style="width: 100%; height: 100%;" type="text" name="input-pago-numero" id="input-pago-numero" required="required"></td>
													<td colspan=2 class=xl12025986 style='height:  10px;color:black;'>de</td>
													<td class=xl12025986 style='height:10px;color:black;'><input style="width: 100%; height: 100%;" class="financiero"  type="text" name="input-pago-de-total" id="input-pago-de-total" required="required" ></td>
												...
												<tr height=23 style='mso-height-source:userset;height:17.25pt'>
													...
													<td colspan=5 class=xl14225986 style='border-left:none;height:  10px;color:black;'>
														<select style="width: 100%; height: 100%;"  name="select-codigo-a" id="select-codigo-a" readonly="readonly">
														</select>
													</td>
													<td colspan=4 class=xl14225986 style='border-left:none;height:  10px;color:black;'>
														<select style="width: 100%; height: 100%;"  name="select-convenio-a" id="select-convenio-a" readonly="readonly">
														</select>
													</td>
													<td colspan=4 class=xl14225986 style='height:10px;color:black;'><input style="width: 100%; height: 100%;" type="text" name="input-rp-valor-a" id="input-rp-valor-a" class="decimalPesos financiero" value="$ 0" required="required"></td>
												...
												<tr height=60 style='mso-height-source:userset;height:45.0pt'>
													...
													<td colspan=5 class=xl13625986 style='height:10px;color:black;'><input style="width: 100%; height: 100%;" type="text" class="decimalPesos refresh-saldo pago-efectuar financiero" name="input-valor-pago-efectuar" id="input-valor-pago-efectuar" value="$ 0" required="required"></td>
												...
												<tr height=43 style='mso-height-source:userset;height:32.25pt'>
													...
													<td colspan=29 class=xl13625986 style='height:10px;color:black;'><input style="width: 100%; height: 100%;" type="text" name="input-giros-efectuados" id="input-giros-efectuados" class="decimalPesos refresh-saldo financiero" value="$ 0" required="required"></td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
											...
											<tr height=52 style='mso-height-source:userset;height:39.6pt'>
												...
												<tr height=24 style='mso-height-source:userset;height:18.0pt'>
													...
													<td colspan=35 rowspan=2 class=xl10225986 width=1086 style='border-right:.5pt solid black;border-bottom:.5pt hairline black;width:815pt'>Yo <span id="nombre-contratista-juramento"> </span>,
														...
														<br> El (los) número(s) o referencias(s) de las(s) planilla(s) por el aporte de(l) (los) mes(es) de <input style="width: 200px; height:20px" type="text" name="input-mes-planilla" id="input-mes-planilla" required="required"  data-toggle="tooltip" title="Ejemplo: Enero, Febrero, ..." data-placement="top"> es(son):<br>
														<input style="width: 200px; height:20px" type="text" name="input-numero-planilla" id="input-numero-planilla"  required="required" data-toggle="tooltip" title="Ejemplo: 00000000, 11111111, ..." data-placement="top"> (Anexo copia(s) de la(s) planilla(s)).</font>
														<div class="form-group row" >
															...
															<div class="col-md-12 col-lg-12">
																...
																<div id="div_anexo_planilla" style="    margin-top: 6px;" data-toggle="tooltip" title="Los archivos subidos reemplezarán los cargados anteriormente para este periodo" data-placement="right" class="col-md-4 col-lg-4">
																	<div class="alert-danger">Máximo 3 archivos diferentes, tenga en cuenta que el peso total no debe superar los 50mb.</div>
																	<input id="anexo_planilla" multiple name="file[]" type="file" class="filestyle financiero" data-btnClass="btn-danger" data-buttonBefore="true" runat="server" data-text="&nbspPlanilla(s) y/o Extras">
																	<button class="btn btn-warning" id="BT_anexos_orfeo" title="Anexos Orfeo" data-toggle="modal" data-target="#modal-documentos-orfeo">
																		<span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span> Anexos Orfeo
																	</button> 
																</div>
															...
															<div class="col-md-12 col-lg-12">
																...
																<div class="col-md-4 col-lg-4" id="form-bt-orfeo_cesion" style="margin-top: 6px;">
																	<a class="btn btn-warning" id="BT_agregar_documento_orfeo_cesion" title="Anexos Pago 1 cesión" style="display: none;">
																		<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Anexos Pago 1 cesión
																	</a>
																</div>	
																...
																<div class="col-md-12 col-lg-12 mt-2">
																	<div class="row"> 
																		<div class="col-md-12 col-lg-12 item-grid">
																			<div class="col-md-4 col-lg-4">
																				<strong>Tamaño total de anexos (50MB Max)</strong>
																			</div>
																			<div class="col-md-6 col-lg-6">
																				<input type="text" name="validacion-anexos" id="validacion-anexos" class="form-control mb-1" readonly="readonly" >
																			</div>
																		</div>
																	</div>
																	<div class="row"> 
					...
					<div class="tab-pane active" id="listado" role="tabpanel">
						...
						<div class="form-group row" >
							<div class="col-md-7" style="padding-right:0px ">
								...
								<div class="input-group col-sm-8 col-md-6" style="padding-left: 15px;padding-right: 15px;" >
									<select id="select-estado-lista" name="estado"  class="selectpicker form-control">
										<!--<option value="1" selected>Ver</option>-->
										<option value="2" >Historico</option>
										<option value="3" selected>Revisar</option> 
									</select>
								</div>
							</div>
						</div>
						...
						<div class="form-group row" >
							...
							<div class="col-md-7" style="padding-right:0px ">
								<label  for="fecha_inicio"  class="col-sm-4 col-md-4 control-label">Fechas de corte </label>
								<div class="input-group col-sm-8 col-md-6" style="padding-left: 15px;padding-right: 15px;" >
									<span class="input-group-addon"><i style="margin-right: 0px;" class="fa fa-calendar"></i></span>
									<input style="background-color: white; z-index: 1;" maxlength="500" class="form-control datepicker-class" 
										id="fecha_inicio" name="fecha_inicio" placeholder="dd/mm/aaaa" type="text" value="<?php echo date( "d/m/Y", strtotime(" -1 month",$hoy ) ) ; ?>">
								</div>
							</div>
							<div class="col-md-5" style="padding-right:0px ">
								<div class="input-group col-md-10" style="padding-left: 15px;padding-right: 15px;" >
									<span class="input-group-addon"><i style="margin-right: 0px;" class="fa fa-calendar"></i></span>
									<input style="background-color: white; z-index: 1;" maxlength="500" class="form-control datepicker-class" id="fecha_fin" 
									name="fecha_fin" placeholder="dd/mm/aaaa" type="text" value="<?php echo date("d/m/Y"); ?>">
								</div>								
							</div>
						</div>
						<!--
						...
						<div class="form-group row ">
							<div class="col-md-7" style="padding-right:0px ">
								<label  for="btn-consultar"  class="col-sm-4 col-md-4 control-label"></label>
								<div class="col-md-7">
	...
	<div class="modal fade" id="modal-codigo-confirmacion" data-keyboard="false"  data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="modal-codigo-confirmacion">
					...
					<div class="modal-body">
						<fieldset>
							<div class="modal-body" id="contenedor">
								<div class="form-group row">
									<label for="codigo_confirmacion">Ingrese el código de seguridad</label>
									<div class="input-group">
										<span class="input-group-addon" id="basic-addon3">#</span>
										<input type="text" class="form-control" name="codigo_confirmacion" id="codigo_confirmacion" aria-describedby="basic-addon3" maxlength="10" placeholder="Digite código de seguridad enviado a su correo">
									</div>
									<div class="input-group"><small class="mt-2">Si no recibió el correo con el código, puede solicitar un nuevo <a href="#" id="solicitar_codigo">código</a></small></div>
	...
	<div class="modal fade" id="modal-historial" data-keyboard="false"  data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="modal-historial">
		<form id="form-modal-historial" class="form-horizontal" enctype="multipart/form-data" method="post">
			<div class="modal-dialog" role="document" >
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						<fieldset>
							<div class="modal-body" id="contenedor">
								<table class="table table-hover" cellspacing="0" width="100%" id='tbl_historial'>
									<thead>
										<tr>
										<th>Nombre</th>            
										<th>Apellido</th>            
	...
	<div class="modal fade" id="modal-datos-orfeo" data-keyboard="false"  data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="modal-datos-orfeo">
		<form id="form-modal-datos-orfeo" class="form-horizontal" enctype="multipart/form-data" method="post">
			<div class="modal-dialog" role="document" >
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title">Datos del informe Radicado en ORFEO</h4>	
					</div>
					<div class="modal-body" id="contenedor-datos-orfeo">						
	...
	<div class="modal fade" id="modal-firmantes" data-keyboard="false"  data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="modal-firmantes">
		<form id="form-modal-firmantes" class="form-horizontal" enctype="multipart/form-data" method="post">
			<div class="modal-dialog" role="document" >
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title">Usuarios Firmantes en el Informe de Pago</h4>	
					</div>
					<div class="modal-body" id="contenedor-firmantes">						
