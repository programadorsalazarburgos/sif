...
<head>
	...
	<script src="Js/Informe_Pago_Consulta.js?v=2020.06.04"></script>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-header">
					<h1 style="font-size: 45px;">Consulta Informes para Pago</h1>
									...
									<div class="form-group text-center row">
										<div align=center>
											<table border=0 cellpadding=0 cellspacing=0 width=1107 class=xl6425986 style='border-collapse:collapse;table-layout:fixed;width:831pt'>
												...
												<tr height=10 style='mso-height-source:userset;height:7.5pt'>
													<td height=10 class=xl6325986 style='height:7.5pt'></td>
													<td colspan=11 rowspan=3 class=xl18525986>Fecha: 01/02/2019</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
												...
												<tr height=16 style='mso-height-source:userset;height:12.6pt'>
													...
													<td colspan=11 rowspan=3 class=xl18525986>Versión: 2</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
												...
												<tr height=39 style='mso-height-source:userset;height:29.25pt'>
													...
													<td colspan=14 class=xl12025986 style='border-left:none;height:  10px;color:black;'><input class="financiero" style="width: 100%; height: 100%;" type="text" name="input-ciiu" id="input-ciiu" ></td>
												...
												<tr height=23 style='mso-height-source:userset;height:17.25pt'>
													<td height=23 class=xl6325986 style='height:17.25pt'></td>
													<td colspan=4 class=xl14225986 style='height:10px;color:black;'><input style="width: 100%; height: 100%;" type="text" class="rp-contenido financiero" name="input-rp-contenido-a" id="input-rp-contenido-a" value="a) xxxx"></td>
													...
													<td colspan=5 class=xl14225986 style='height:10px;color:black;'><input style="width: 100%; height: 100%;" type="text" class="rp-contenido financiero" name="input-rp-contenido-c" id="input-rp-contenido-c" value="c)"></td>
													<td colspan=5 class=xl14225986 style='border-left:none;height:  10px;color:black;'>
												...
												<tr height=23 style='mso-height-source:userset;height:17.25pt'>
													<td height=23 class=xl6325986 style='height:17.25pt'></td>
													<td colspan=4 class=xl14225986 style='height:10px;color:black;'><input style="width: 100%; height: 100%;" type="text" class="rp-contenido financiero" name="input-rp-contenido-b" id="input-rp-contenido-b" value="b)"></td>
													<td colspan=5 class=xl14225986 style='border-left:none;height:  10px;color:black;'>
														<select style="width: 100%; height: 100%;" class="financiero" name="select-codigo-b" id="select-codigo-b">
														</select>
													</td>
													<td colspan=4 class=xl14225986 style='border-left:none;height:  10px;color:black;'>
														<select style="width: 100%; height: 100%;" class="financiero" name="select-convenio-b" id="select-convenio-b">
														</select>
													</td>
													...
													<td colspan=5 class=xl14225986 style='height:10px;color:black;'><input style="width: 100%; height: 100%;" type="text" class="rp-contenido financiero" name="input-rp-contenido-d" id="input-rp-contenido-d" value="d)"></td>
													<td colspan=5 class=xl14225986 style='border-left:none;height:  10px;color:black;'>
												...
												<tr height=46 style='mso-height-source:userset;height:34.5pt'>
													...
													<td colspan=13 class=xl12225986 style='height:  10px;color:black;'><textarea  class="financiero" rows="5" style="resize: vertical;width: 100%; height: 100%;" type="text" name="textarea-producto" id="textarea-producto" > </textarea></td>													
													...
													<td colspan=16 class=xl12225986 style='border-left:none;height:  10px;color:black;'>
														<textarea rows="5" style="resize: vertical;width: 100%; height: 100%;"  class="financiero" type="text" name="textarea-mecanismo-verificacion" id="textarea-mecanismo-verificacion" placeholder="(En este espacio, por favor indique si adjunta medio magnético , anexos físicos o por favor mencione el nombre de la Tabla de retención documental del Sistema ORFEO donde reposa la prueba del producto entregado por usted)."></textarea>
													</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													...
													<td colspan=35 rowspan=2 class=xl10225986 width=1086 style='border-right:.5pt solid black;border-bottom:.5pt hairline black;width:815pt'>Yo <span id="nombre-contratista-juramento"> </span>,
														...
														<div class="form-group row" >
															<div class="col-md-12 col-lg-12">
																...
																<br>
																<div id="div_anexo_planilla" style="    margin-top: 6px;" data-toggle="tooltip" title="Los archivos subidos reemplezaran los cargados anteriormente" data-placement="right" class="col-md-4 col-lg-4">
																	<input accept="application/pdf" id="anexo_planilla" multiple name="file[]" type="file" class="filestyle financiero" data-btnClass="btn-danger" data-buttonBefore="true" runat="server" data-text="&nbspPlanilla(s) y/o Extras">
																</div>
												...
												<tr height=21 style='mso-height-source:userset;height:16.15pt'>
													...
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td colspan=11 class=xl9025986><span>Firma Contratista</span></td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6625986>&nbsp;</td>
												...
												<tr height=23 style='mso-height-source:userset;height:17.65pt'>
													<td height=23 class=xl6325986 style='height:17.65pt'></td>
													<td class=xl6525986>&nbsp;</td>
													<td colspan=12 class=xl9025986><span>Revisó Apoyo a la Supervisión</span></td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
													<td class=xl6425986>&nbsp;</td>
					...
					<div class="tab-pane active" id="listado" role="tabpanel">
						...
						<div class="form-group row" >
							<div class="col-md-7" style="padding-right:0px ">
								...
								<div class="input-group col-sm-8 col-md-6" style="padding-left: 15px;padding-right: 15px;" >
									<select id="select-mes-informe" name="select-mes-informe[]"  class="selectpicker form-control" multiple></select>
								</div>
							</div>
						</div>
						<div class="form-group row" >
