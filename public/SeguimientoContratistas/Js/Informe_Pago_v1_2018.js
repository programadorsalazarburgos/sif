			...
			if (cantidadAnterior < cantidadDigitada) {
				for (var i = cantidadDigitada - 1; i >= cantidadAnterior; i--) {
					...
					$("#"+$(selfData).closest("form")[0].id+" #input-descripcion-"+cantidadAnterior).parent().parent().after(`
						...
						<tr data-cantidad="`+cantidadDigitada+`" class="obligacion obligacion-`+numerRow+`" height=42 style='mso-height-source:userset;height:31.5pt'>
						<td height=42 class=xl6325986 style='height:31.5pt'></td>
						<td colspan=35 class=xl12925986 width=1086 style='width:815pt;height:10px;color:black;'><textarea rows="2" style="margin-bottom: -5px;width: 100%; height: 100%;" type="text" name="input-descripcion-`+numerRow+`" id="input-descripcion-`+numerRow+`" placeholder="En este espacio mencione las acciones desarrolladas por usted en cumplimiento de esta obligación contractual, durante el período del informe"></textarea></td>
						<td class=xl6425986>&nbsp;</td>
						<td class=xl6425986>&nbsp;</td>
						<td class=xl6425986>&nbsp;</td>
						<td class=xl6425986>&nbsp;</td>
			...
			success: function(informe){
				...
				$.ajax({
					...
					success: function(informeDetallado){
						...
						generarPDFInformeDetallado(informe);
					},error: function(result){
						console.log("Error: "+result);
					}
				});
...
/*																		cleaner:{
	...
	*/
				...
				success: function(result){
					if (result == 1 || result == 2 || result == 3) {
						...
						if ($('#input-aprobado').is(":checked"))
							...
							estado = "revisado y no aprobado";
						var  rol = "";
						if (result == 1)
							rol = "el apoyo a la supervisión.";
						if (result == 2)
							rol = "el apoyo financiero.";
						if (result == 3)
							rol = "el apoyo al supervisor.";
						var contenido = "El informe de pago del periodo "+informeSelectedData["input-periodo-inicio"]+" - "+informeSelectedData["input-periodo-fin"]+" ha sido "+estado+" por "+rol;
						var notificacion = {
							VC_Url:"SeguimientoContratistas/Informe_Pago.php",
							VC_Icon:"fa fa-list-alt",
							VC_Contenido:contenido,
		...
		$.ajax({
			...
			success: function(result){
				if (result == 1 || result == 2 || result == 3) {
					...
					var  rol = "";
					if (result == 1)
						rol = "el apoyo a la supervisión y se encuentra disponible para su descarga.";
					if (result == 2)
						rol = "el apoyo financiero y se encuentra disponible para su descarga.";
					if (result == 3)
						rol = "el apoyo al supervisor y se encuentra disponible para su descarga.";
					var contenido = "El informe detallado del periodo "+informeSelectedData["input-periodo-inicio"]+" - "+informeSelectedData["input-periodo-fin"]+" ha sido "+estado+" por "+rol;
					var notificacion = {
						VC_Url:"SeguimientoContratistas/Informe_Pago.php",
						VC_Icon:"fa fa-list-alt",
						VC_Contenido:contenido,
	...
	function generarPDFInformeDetallado(informe) {
		...
		descargarPDFInformeDetallado(generalPDF);
	...
	function generarPDFInforme(informe) {
		...
		descargarPDFInforme(generalPDF);
		generalPDF.numeroObligaciones = informe["input-numero-obligaciones"];
	}
...
function descargarPDFInforme(generalPDF) {
	var count = 0 ;
	var bandera = false;
	var dd = {
		pageSize: 'legal',
		...
		watermark: {text: 'APROBADO', color: 'gray', opacity: 0.6, bold: true, italics: false,marginX:0,marginY:60},
		content: [
		{ 
			style: 'tableExample',
			table: {
				...
				[{},{text:{}},{text:'Fecha: 05/02/2018',style: 'general',margin: [0, 2, 0, 0]}],
				[{},{text:'INFORME PARA PAGO (PERSONA NATURAL Y/O JURÍDICA)',style: 'titles',margin: [0, 12, 0, 0]},{text:'Versión:  1',style: 'general',margin: [0, 12, 0, 0]}]
		...
		},
		{
			...
			table: {
				...
				{text:'Valor total del Contrato \n(Incluidas adiciones)',style: 'general',border: [true, true, true, false]},
				{margin: [0, 5, 0, 0],text:generalPDF["input-valor-pago-efectuar"],style: 'general',border: [true, true, true, false]},
				{margin: [0, 5, 0, 0],text:'Valor en Letras',style: 'general',border: [true, true, true, false]},
				{margin: [0, 5, 0, 0],text:generalPDF["input-valor-letras"],style: 'general',border: [true, true, true, false]},
				],[
			...
			table: {
				...
				[
				{text:'¿Es usted persona natural del régimen común?',style: 'general',border: [true, true, true, false]},
				...
				[
				{text:'¿Es usted persona natural del régimen simplificado?',style: 'general',border: [true, true, true, false]},
				...
				[
				{text:'Tiene dependientes a su cargo? (Decreto 1070 de 2013 Art. 387 E.T.)',style: 'general',border: [true, true, true, false]},
				...
				[
				{text:'¿Efectua pago en su cuenta AFC? De ser así en observaciones indique el valor mensual',style: 'general',border: [true, true, true, false]},
				...
				[
				{text:'Efectua pagos por concepto de medicina prepagada? (Art. 387 E.T.) de ser así, en observaciones indique el valor mensual que paga',style: 'general',border: [true, true, true, false]},
			...
			table: {
				...
				{margin: [0, 0, 0, 0],text:'',style: 'subtitlecenter',border: [false, false, false, false]},
				{margin: [0, -3, 0, 0],text:generalPDF['span-cargo-contratista'],style: 'subtitle',border: [false, false, false, false]},
				{margin: [0, 0, 0, 0],text:'',style: 'subtitlecenter',border: [false, false, true, false]}],

				[{margin: [0, 0, 0, 0],text:'',style: 'subtitlecenter',border: [true, false, false, false]},
				{margin: [0, -6, 0, 0],text:generalPDF['span-rol-supervisor'],style: 'subtitle',border: [false, false, false, false]},
				{margin: [0, 0, 0, 0],text:'',style: 'subtitlecenter',border: [false, false, false, false]},
				...
				[{margin: [0, 0, 0, 0],text:'',style: 'subtitlecenter',border: [true, false, false, false]},
				{margin: [0, -3, 0, 0],text:generalPDF['span-rol-apoyo'],style: 'subtitle',border: [false, false, false, false]},
				{margin: [0, 0, 0, 0],text:'',style: 'subtitlecenter',border: [false, false, false, false]},
				{margin: [0, -3, 0, 0],text:'',style: 'subtitle',border: [false, false, false, false]},
				{margin: [0, 0, 0, 0],text:'',style: 'subtitlecenter',border: [false, false, true, false]}],
...
function descargarPDFInformeDetallado(generalPDF) {
	var count = 0 ;
	var bandera = false;
	var dd = {
		pageSize: 'legal',
