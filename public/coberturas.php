...
<head>
	...
	<script src="js/bienvenida_version.js?v=2021.02.16.2"></script>
</head>
<body>
	<span id="inicio"></span>
	...
	<div class="row contenedor-landing-page" style="height: 70% !important; padding: 3%">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="row" style="background-color: #272727 !important; color: #ffffff !important; padding-bottom: 7vh !important;">
