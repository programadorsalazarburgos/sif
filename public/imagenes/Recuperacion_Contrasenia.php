            ...
            <div class="col-md-8 col-md-offset-2">
              <div class="login-panel panel panel-green">
                ...
                <div class="panel-body">
                  <div class="jumbotrom">
                  	<h3>Porfavor escribanos al correo <a href="mailto:si.clan@idartes.gov.co?Subject=Olvide%20Contraseña"><font color="#27ba3d">si.clan@idartes.gov.co</font></a> indicando su nombre y número de cédula y le daremos respuesta por dicho medio.</h3>
                  	<center><input type="button" name="ver-ejemplo" id="ver-ejemplo" value="Ver Ejemplo" data-toggle="modal" data-target="#modal-contrasenia" class="btn btn-primary"></center>
                  </div>
                </div>
                </div>
            </div>
