...
"<tr>
	...
	<td  class='text-center'>".$g['lugar_atencion']."</td>
	<td>".$g['fecha_creacion']."</td>
	<td>".$g['abrio']."</td>
	<td>".$g['horario']."</td>
	<td class='text-center'><a href='#' data-toggle='modal' data-target='#modal_estudiantes_grupo' class='consultar_listado_estudiantes_grupo_arte_escuela btn btn-warning' data-id_grupo='".$g['grupo']."'>".$g['estudiante']."</a></td>
	...
	$return .= "<td class='text-center'><a href='#' data-toggle='modal' data-target='#modal_caracterizaciones_grupo_ae' class='consultar_caracterizaciones_grupo_arte_escuela btn ".$disabled."' data-id_grupo='".$g['grupo']."'>".$text."</a>".$observaciones."</td>";
	$disabled = 'btn-success ';
	$text = 'Descargar';
	...
	$return .= "<td class='text-center'><a href='#' data-toggle='modal' data-target='#modal_planeacion_grupo_ae' class='btn consultar_planeacion_grupo_arte_escuela ".$disabled." '  data-id_grupo='".$g['grupo']."'>".$text."</a>".$observaciones."</td>";
	...
	$return .= "<td class='text-center'><a href='#' data-toggle='modal' data-target='#modal_valoracion_grupo_ae' class='btn consultar_valoracion_grupo_arte_escuela ".$disabled." '  data-id_grupo='".$g['grupo']."'>".$text."</a>".$observaciones."</td>";*/
