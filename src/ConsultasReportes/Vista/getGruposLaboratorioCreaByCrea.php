...
foreach ($this->getVariables()['grupos'] as $g) {
	...
	<td>".$g['crea']."</td>
	<td>".$g['localidad_crea']."</td>
	<td>".$g['area']."</td>
	<td>".$g['modalidad_atencion']."</td>
	<td>".$g['CONVENIO']."</td>
	<td>".$g['categoria_poblacion']."</td>
	<td>".$g['subcategoria_poblacion']."</td>
	<td>".$g['institucion']."</td>
	<td>".$g['aliado']."</td>
	<td>".$g['lugar_atencion']."</td>
	<td>".$g['localidad_lugar_atencion']."</td>
	...
	$return .= "<td class='text-center'><a href='#' data-toggle='modal' data-target='#modal_caracterizaciones_grupo_lc' class='consultar_caracterizaciones_grupo_laboratorio_clan btn ".$disabled."' data-id_grupo='".$g['grupo']."'>".$text."</a>".$observaciones."</td>";
	$disabled = 'btn-success ';
	$text = 'Descargar';
	...
	$return .= "<td class='text-center'><a href='#' data-toggle='modal' data-target='#modal_planeacion_grupo_lc' class='btn consultar_planeacion_grupo_laboratorio_crea ".$disabled." '  data-id_grupo='".$g['grupo']."'>".$text."</a>".$observaciones."</td>";
	...
	$return .= "<td class='text-center'><a href='#' data-toggle='modal' data-target='#modal_valoracion_grupo_lc' class='btn consultar_valoracion_grupo_laboratorio_crea ".$disabled." '  data-id_grupo='".$g['grupo']."'>".$text."</a>".$observaciones."</td>";*/
