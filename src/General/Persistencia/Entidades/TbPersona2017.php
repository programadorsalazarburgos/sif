...
 * Object que representa la tabla 'tb_persona_2017'
...
	private $tx_foto_perfil;
	private $tx_firma_escaneada;
...
	 * Obtiene el valor de VC_Cargo
	 * @return mixed
	 */
	public function getVcCargo()
	{
			return $this->vc_cargo;
	}

	/**
	 * Asigna el valor para VC_Cargo
	 * @param mixed $VC_Cargo 
	 */
	public function setVcCargo($vc_cargo)
...
	 * Obtiene el valor de TX_Foto_Perfil
     * @return mixed
     */
    public function getTxFotoPerfil()
    {
        return $this->tx_foto_perfil;
    }

    /**
     * Asigna el valor para TX_Foto_Perfil
     * @param mixed $tx_foto_perfil
     *
     * @return self
     */
    public function setTxFotoPerfil($tx_foto_perfil)
    {
        $this->tx_foto_perfil = $tx_foto_perfil;

        /*return $this;*/
    }

	/**
	 * Obtiene el valor de TX_Firma_Escaneada
     * @return mixed
     */
    public function getTxFirmaEscaneada()
    {
        return $this->tx_firma_escaneada;
    }

    /**
     * Asigna el valor para TX_Firma_Escaneada
     * @param mixed $tx_firma_escaneada
     *
     * @return self
     */
    public function setTxFirmaEscaneada($tx_firma_escaneada)
    {
        $this->tx_firma_escaneada = $tx_firma_escaneada;
