<?php 
  ...
  $return .='<div class="panel-heading"><center><h4>LABORATORIOS</h4></center></div>';
  $return .='<div class="panel-body">';
  $return .='<table id="table_Consolidado_Grupos_Comunidad" class="table table-striped table-bordered table-hover" width="100%">';
  $return .= $encabezado;
  ...
  $cambiolocalidad =  $c['Localidad'];
    ...
    if ($localidadActual != $c['Localidad'] && $clave != 0){
      ...
      $return .="<tr style='background-color: #EC7063;' class='text-center'>";
    ...
    if($c['Localidad'] == $cambiolocalidad){
      ...
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['EXPERIENCIA']."</center></td>";
      $return .=" <td style='background-color: #F2D7D5'><center>". $c['ARTISTAS']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['GESTANTES_R']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['TOTAL_DE_0_3_ANIOS_R']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['TOTAL_DE_4_6_ANIOS_R']."</center></td>";
      $return .=" <td style='background-color: #F2D7D5'><center>". $c['CUIDADORES']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['AFRODESCENDIENTE_R']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['INDIGENA_R']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['RAIZALES_R']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['ROM_R']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['CAMPESINA_R']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['DISCAPACIDAD_R']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['CONFLICTO_R']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['PRIVADOS_R']."</center></td>";
      $return .="	<td style='background-color: #F2D7D5'><center>". $c['NINGUNO_R']."</center></td>";
      $return .="	<td style='background-color: #D98880'><center><strong>". $c['TOTAL_R']."</strong></center></td>";
      $return .="</tr>";
    }
  ...
  if (sizeof($this->getVariables()['TotalLaboratorios']) != 0){
    ...
    $return .="<tr style='background-color: #641E16; color: white;' class='text-center'>";
