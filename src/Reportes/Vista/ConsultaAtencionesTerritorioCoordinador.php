...
$return .='<table id="table_Atenciones_Familiar" class="table table-striped table-bordered table-hover" width="100%">';
$return .= $encabezado;

foreach ($this->getVariables()['entornoFamiliarCoordinador'] as $clave => $e){
  ...
  if (count($this->getVariables()['entornoFamiliarCoordinador']) == ($clave + 1) ){
    $return .="<tr style='background-color: #5DADE2;' class='text-center'>";
...
$return .='<div class="panel-body">';
$return .='<table id="table_Atenciones_Institucional" class="table table-striped table-bordered table-hover" width="100%">';
$return .= $encabezado;
...
foreach ($this->getVariables()['entornoInstitucionalCoordinador'] as $clave => $e)
{
  ...
  if (count($this->getVariables()['entornoInstitucionalCoordinador']) == ($clave + 1) ) {
    $return .="<tr style='background-color: #F8C471;' class='text-center'>";
...
$return .='<div class="panel-heading"><center><h4>LABORATORIOS E INTERVENCIONES</h4></center></div>';
$return .='<div class="panel-body">';
$return .='</div></div>';
...
$return .='<table id="total_Atenciones_territorio" class="table table-striped table-bordered table-hover" width="100%">';
