...
<div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" class="cargar_datos_dupla" data-id_dupla="<?= $ts['Pk_Id_Dupla'] ?>" data-parent="#acordion_duplas" href="#panel_<?= $ts['Pk_Id_Dupla'] ?>"> Codigo de la Dupla:  <?= $ts['VC_Codigo_Dupla'] ?>
          </a>
        </h4>
      </div>
